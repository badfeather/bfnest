...
<section id="comments" class="entry-comments comments-area">
	...
	<?php if ( have_comments() ) { ?>
		<h1 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'bfn' ),
	...
	<?php if ( ! comments_open() && '0' != get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) { ?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'bfn' ); ?></p>
	<?php } // endif ?>
