 ...
 * @return void
 */
function bfnest_woocommerce_setup() {
 ...
 */
function bfnest_woocommerce_active_body_class( $classes ) {
	$classes[] = 'woocommerce-active';

	return $classes;
}
add_filter( 'body_class', 'bfnest_woocommerce_active_body_class' );
 ...
 */
function bfnest_woocommerce_products_per_page() {
	return 12;
}
add_filter( 'loop_shop_per_page', 'bfnest_woocommerce_products_per_page' );
 ...
 *
	<?php
		if ( function_exists( 'bfnest_woocommerce_header_cart' ) ) {
			bfnest_woocommerce_header_cart();
		}
	?>
 */
